...
--
-- Host: localhost
-- Generation Time: Jan 10, 2021 at 06:16 PM
...
(5, 1, 'dong-ho-citicen-BI5000-87L-9_1587518940.jpg.jpg'),
(6, 6, 'rolex-day-date-36-128238.png'),
(7, 6, 'rolex-day-date-e1590801721708.jpg'),
(8, 6, 'rolex-nam-118138-003.jpg'),
(9, 6, 'dong-ho-rolex-mat-xanh-3-e1584602977722.jpg'),
...
(32, 'Cu Tèo', 'tuyenbui3030', '$2y$10$5YCIjztsESpBKW1oNUaKiOfeRyuvy2CurMTj4H5XL37nFDxCNsVui', 'Customer', 'tuyenbui3030@gmail.com', 'bcc22617d63b29bd6bde32a8b294850116d3ff8adf6bf43836c160f2a86c28b9ef4a7c40f8de51c868b16b1654254c979a55', b'0', '01TTT', '2021-01-02'),
...
(34, 'Bùi Quang Tuyến', 'janguam', '$2y$10$71G8/iTnED35.OUiRmAMf.dVUQptrPUA2cJC9SrhYZbfmzMiwSMoS', 'Customer', 'dsadsd@gmail.com', '157bb6f360e46823b98ebd732dd491b3be417b6c336246f1cfb63468fd2481261f6b5ad0376125b34d48388474ad0b97a131', b'1', '01TTT', '1999-08-11');
...
--
ALTER TABLE `orderdetails`
  MODIFY `orderDetail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
...
--
ALTER TABLE `photos`
  ADD CONSTRAINT `FK_PHOTOS_PRODUCT` FOREIGN KEY (`photo_prod_id`) REFERENCES `products` (`prod_id`);
