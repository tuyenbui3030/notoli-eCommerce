            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <div class="login-box">
                        ...
                        <form class="form form--login" method="POST" id="form_login" name="form_login"
                            action="./Login/loginPageController">
                            <div class="form__group mb--20">
                                <label class="form__label form__label--2" for="login_username">Tên tài khoản <span
                                        class="required">*</span></label>
                                <input type="text" class="form__input form__input--2" id="login_username"
                                    name="login_username">
                            </div>
                            <div class="form__group mb--20">
                                <label class="form__label form__label--2" for="login_password">Mật khẩu <span
                                        class="required">*</span></label>
                            ...
                            <div class="d-flex align-items-center mb--20">
                                <div class="form__group mr--30">
                                    <input type="submit" value="Đăng nhập" class="btn-submit" name="btnLogin"
                                        id="btnLogin">
                                </div>
