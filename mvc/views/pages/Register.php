                    ...
                    <div class="register-box">
                        ...
                        <form class="form form--login" id="registration-form" action="./Register/UserRegister"
                            ...
                            <div class="form__group mb--20">
                                <label class="form__label form__label--2" for="register_fullname">Họ tên <span
                                        class="required"></span></label>
                                <span class="message"><i id="message_fullname"></i></span>
                                <input type="text" class="form__input form__input--2" id="register_fullname"
                                    name="register_fullname">
                            </div>
                            <div class="form__group mb--20">
                                <label class="form__label form__label--2" for="register_birthday">Ngày sinh <span
                                        class="required"></span></label>
                                <span class="message"><i id="message_birthday"></i></span>
                                <input type="date" class="form__input form__input--2" id="register_birthday"
                                    name="register_birthday">
                            </div>
                            <div class="form__group mb--20">
                                <label class="form__label form__label--2" for="register_city">Thành phố <span
                                        class="required"></span></label>
                            ...
                            <div class="form__group mb--20">
                                ...
                                <input type="password" class="form__input form__input--2" id="register_retypePassword"
                                    name="register_retypePassword">
                            </div>
                            <div class="form__group mb--20">
                            ...
                            <div class="form__group mb--20">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <label class="form__label form__label--2" for="register_captcha">Captcha <span
                                                class="required">*</span></label>
                                        <span class="message"><i id="message_captcha"></i></span>
                                        <input type="text" class="form__input form__input--2" id="register_captcha"
